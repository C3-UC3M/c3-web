...
<button class="presentation-launcher"
    onclick="openPresentation('/assets/slides/Liqid-UC3M_presentacion.pdf')"
    aria-label="Start presentation: Presentation slides"
    title="Open slides">
    <img loading="lazy" src="/assets/images/thumbnails/Liqid-UC3M_presentacion-thumb.jpg" alt="Preview image for presentation slides">
